...
UAE accounting on ERPNext: bookkeeping, VAT, e-invoicing, corporate tax, and compliance tracking.

### UAE localization

TaxMate is UAE-first. It applies ERPNext's built-in UAE VAT features (regional fields, tax templates, print formats, UAE VAT Settings, UAE VAT 201) and does not modify ERPNext core.

- On install/migrate, TaxMate runs ERPNext UAE regional setup so fields and print formats are ready before company onboarding.
